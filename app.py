...
def shows():
  ...
  for shw in shows:
    show = {}
    show["venue_id"] = shw.venue_id
    show["venue_name"] = shw.venue.name
    show["artist_id"] = shw.artist_id
    show["artist_name"] = shw.artist.name
    show["artist_image_link"] = shw.artist.image_link
    show["start_time"] = shw.start_time
